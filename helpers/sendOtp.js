...
const sendOtp = async (email) => {
  try {
    ...
    await redisClient.set(email, otp, { EX: 300 }); //cache for 5 minutes
    ...
    <p style="margin: 0; font-size: 38px; text-align: left; mso-line-height-alt: 45.6px;"><span style="font-size:38px;"><span style=""><strong><span style="">Complete your</span></strong></span><span style=""><strong><span style=""> </span></strong></span></span></p>
    <p style="margin: 0; font-size: 38px; text-align: left; mso-line-height-alt: 45.6px;"><span style="font-size:38px;"><strong><span style="">OTP Verification</span></strong></span></p> 
    </div>
    </td>
    </tr>
    </table>
    ...
    <p style="margin: 0; font-size: 15px; text-align: left; mso-line-height-alt: 30px;"><span style="font-size:15px;">Hi there</span></p>
    ...
    <div style="font-family: Arial, sans-serif">
    <div class="" style="font-size: 14px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; mso-line-height-alt: 28px; color: #000000; line-height: 2;">
    <p style="margin: 0; font-size: 15px; mso-line-height-alt: 30px;"><span style="font-size:15px;">If you did not associate your address with GhImportExpo account, please ignore this message and do not click on the link above.</span></p>
    <p style="margin: 0; font-size: 15px; mso-line-height-alt: 30px;"><span style="font-size:15px;"> </span></p>
    <p style="margin: 0; font-size: 15px; mso-line-height-alt: 30px;"><span style="font-size:15px;">If you experience any issues, don't hesitate to reach out to our support team 👉 <a href="mailto:ghexports23@gmail.com" rel="noopener" style="text-decoration: underline; color: #ef0c0c;" target="_blank" title="hello@use.com">here</a></span></p>
    <p style="margin: 0; font-size: 15px; mso-line-height-alt: 30px;"><span style="font-size:15px;"> </span></p>
    <p style="margin: 0; font-size: 15px; mso-line-height-alt: 30px;"><span style="font-size:15px;"> </span></p>
    <p style="margin: 0; font-size: 15px; mso-line-height-alt: 30px;"><span style="font-size:15px;">Best Regards</span></p>
    <p style="margin: 0; font-size: 15px; mso-line-height-alt: 30px;"><span style="font-size:15px;color:#5327b5;"><strong><span style="">Team GhImportExpo</span></strong></span></p>
    </div>
    </div>
    </td>
    </tr>
    ...
    `;
    await sendMail(email=email,content=content,subject=subject);
